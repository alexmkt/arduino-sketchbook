...
void speaker_bright_wheel_color(){
  int i;
  uint32_t color;
  ...
  for (i=0; i < strip.numPixels(); i++) {
    ...
    //Serial.println(audiobright);
          ...
          if (        
          strip.setPixelColor(i, Color(RedPart(color)/(255-audiobright),GreenPart(color)/(255-audiobright),BluePart(color)/(255-audiobright) ));
